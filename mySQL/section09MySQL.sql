-- --------------------------------------
-- SECTION 9 - MODULARIZACION
-- DBEAVER COMO CLIENTE
-- --------------------------------------
CREATE DATABASE subTienda;
USE subTienda;
...
-- AÑADIR PRODUCTOS LLAMANDO A EL MODULO DE "AñadirProducto"
...
-- AÑADIR CLIENTES LLAMANDO A EL MODULO DE "RegistrarCliente"
...
-- REGISTRAR VENTAS LLAMANDO A EL MODULO DE "RealizarVenta"
